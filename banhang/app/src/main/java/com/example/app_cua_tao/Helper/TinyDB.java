...
public class TinyDB {
    ...
    public ArrayList<ThucPham> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ThucPham> playerList =  new ArrayList<ThucPham>();

        for(String jObjString : objStrings){
            ThucPham player  = gson.fromJson(jObjString,  ThucPham.class);
    ...
    public void putListObject(String key, ArrayList<ThucPham> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ThucPham player: playerList){
